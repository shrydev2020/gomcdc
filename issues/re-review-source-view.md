...
- **完了:** SRC-001 metric別source projectionと積層Combined表示
- **完了:** SRC-002 condition/MC/DC occurrence EntityID
- **完了:** SRC-003 HTML専用source projectionの分離
- **未着手:** SRC-004 mapping failure diagnostics
- **未着手:** UX-001 tooltip拡張
- **既存issue:** PERF-002 interval生成のsweep-line検討
